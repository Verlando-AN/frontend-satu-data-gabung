...
const DatasetLanding = lazy(() => import("@/pages/landing/dataset/Dataset.jsx"))
const DatasetDetailLanding = lazy(() => import("@/pages/landing/dataset/Detail.jsx"))
const SektoralLanding = lazy(() => import("@/pages/landing/sektoral/Sektoral.jsx"))
const UrusanLanding = lazy(() => import("@/pages/landing/urusan/Urusan.jsx"))
const OrganisasiLanding = lazy(() => import("@/pages/landing/organisasi/Organisasi.jsx"))
const PublikasiLanding = lazy(() => import("@/pages/landing/publikasi/Publikasi"))
const PublikasiBukuLanding = lazy(() => import("@/pages/landing/publikasi/Buku.jsx"))
const KontakLanding = lazy(() => import("@/pages/landing/kontak/Kontak.jsx"))
